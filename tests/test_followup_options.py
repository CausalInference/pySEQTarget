...
def test_followup_class():
    ...
    s = SEQuential(
        ...
        fixed_cols=["sex"],
        method = "ITT",
        parameters=SEQopts(followup_class=True,
    ...
    assert matrix == [-6.6000834193414635, 0.36024705241286203, 0.04326409573404126, 
                      ...
                      0.0009258560187318309, 0.011267393559242982, 0.022194521411244304, 
                      0.19115237121222872]
...
def test_followup_spline():
    ...
    s = SEQuential(
        ...
        fixed_cols=["sex"],
        method = "ITT",
        parameters=SEQopts(followup_spline=True,
                           followup_include=False)
    )
    s.expand()
    s.fit()
    ...
    assert matrix == [-6.264817962084417, 0.20125056343026881, 0.12568743032952776, 
                      ...
                      0.37598656666756103, 1.6553848469346044]
